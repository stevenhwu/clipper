...
//    MemoryUtils::estimate_memory(file_name, max_memory);//, bloo1, false_positives);
//    MemoryUtils::estimate_memory(solid_kmers_colour, bloo1, false_positives, terminator); //, terminator);)
//    exit(-1);
